...
Lesson.create!([
  ...
  {name: "Section Two", category: "content", body: "Below is a chart of a frequency spectrum and where certain frequencies live in relation to pitch.  This can give a a clearer understanding of what pitches we are altering when manipulating frequencies.", picture: "frequency_chart.jpg", tutorial_id: 1},
  ...
  {name: "Section Two", category: "content", body: "The Upbeat is the last beat of a measure and is weaker than the downbeat.",  
    picture: "upbeat.png", tutorial_id: 4},
